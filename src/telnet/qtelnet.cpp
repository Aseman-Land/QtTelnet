...
/*!
    ...
    QTelnet object will Q_EMIT connectionError() if the connection
...
*/
uchar QTelnetPrivate::opposite(uchar operation, bool positive)
{
...
bool QTelnetPrivate::isCommand(const uchar c)
{
    return (c == Common::DM);
}

bool QTelnetPrivate::isOperation(const uchar c)
{
...
bool QTelnetPrivate::replyNeeded(uchar operation, uchar option)
{
...
void QTelnetPrivate::setMode(uchar operation, uchar option)
{
    if (operation != Common::DO && operation != Common::DONT)
        return;
...
void QTelnetPrivate::addSent(uchar operation, uchar option)
{
    osent.append(QPair<uchar, uchar>(operation, option));
}

bool QTelnetPrivate::alreadySent(uchar operation, uchar option)
{
